            ...
            <ExhausterInfo
                ...
                description={(
                    <ExhausterWarning
                        ...
                        params={(
                            <>
                                <WarningIndicator variant='critical' title='T' Icon={ThermometerIcon} />
                                <WarningIndicator variant='idle' title='V' Icon={RadioIcon} />
                                <WarningIndicator variant='warning' title='L' Icon={WaterIcon} />
                            </>
                        )}
                    />
                )}
